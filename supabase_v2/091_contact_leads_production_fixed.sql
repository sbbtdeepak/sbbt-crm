-- ============================================================
-- Migration: 091 — contact_leads Production (Fixed)
-- SBBT CRM — Production Database
--
-- Creates ONLY public.contact_leads for production.
-- No foreign keys. No dependencies on sites / profiles.
-- PostgreSQL 17 + Supabase compatible. Idempotent.
-- ============================================================
