...
async function seed() {
  ...
  if (hasSeoColumns) {
    ...
    console.log("⚠️  SEO columns don't exist yet. Seeding with basic data...");
  ...
  for (const t of testimonials) {
    ...
    if (hasSeoColumns) {
      insertData.initials = t.initials;
      insertData.project_type = t.project_type;
      insertData.completion_year = t.completion_year;
      insertData.seo_title = t.seo_title;
      insertData.seo_description = t.seo_description;
      insertData.seo_keywords = t.seo_keywords;
      insertData.og_title = t.og_title;
      insertData.og_description = t.og_description;
      insertData.twitter_title = t.seo_title;
      insertData.twitter_description = t.seo_description;
      insertData.robots = t.robots;
      insertData.canonical = t.canonical;
      insertData.schema_description = t.seo_description;
    }
